...
Note
This tool was created to provide a quick and convenient way to manage Windows background applications, helping users optimize resource usage according to their needs.
### Author
David Mateo Rico Galeano

### Español

Herramienta para habilitar o deshabilitar aplicaciones de Windows 10 y 11 que se ejecutan en segundo plano.
